...
4. Упорядоченная таблица на массиве
...
Максимальная длина поиска в таблице из N элементов при данном алгоритме равна : T = log2N.
...
Для расчета арифметических операций с полиномами используется постфиксная форма.
...
| Инфиксное выражение  | Постфиксное выражение |
| ------------- | ------------- |
| (A + B) * C  | * + A B C  |
| (A + B) * (C + D)  | * + A B + C D  |
Таблица демонстрирует некоторые дополнительные примеры инфиксных выражений и эквивалентных им префиксных и постфиксных записей. 
